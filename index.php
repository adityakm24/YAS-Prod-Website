    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-shrink">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">EVE NFT</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-heading">EVE NFT</div>
                <div class="intro-lead-in">Subtitle</div>
                <a href="#services" class="page-scroll btn btn-xl">Openseas</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                 ...
                 <h3 class="section-subheading text-muted">Ajmal, I need help to learn how to tweak this part. 
                  I don't want this timeline crap. Haha.</h3>
                </div>
</div>
            <div class="row">
                <div class="col-lg-12">
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2009-2011</h4>
                                    <h4 class="subheading">LAUNCH 2000 NFTS FOR YAS PRODUCTIONS</h4>
                                </div><br><br>
                                <div class="timeline-body">
                                    <p class="text-muted">EVE NFT LAUNCHPAD MINTS 2000 NFTS FOR YAS PRODUCTIONS</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                   <br><br> <p class="text-muted">OTP WILL BE INSIDE THE NFTS AND IT WILL BE SHARED WITH YAS PRODUCTIONS
AFTER THEY ARE MINTED ON THE BLOCKCHAIN</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                <br><br>      <p class="text-muted">YAS PRODUCTIONS DOES SALES OFFLINE WITH FIAT CURRENCIES AND WITH CRYPTO
CURRENCIES PAYMENTS PROCESSED BY EVE NFT TEAM</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>July 2014</h4>
                                    <h4 clas="subheading">Phase Two Expansion</h4>
</div>
                                <div class="timeline-body">
                                    <p class="text-muted">BOTH OFFLINE AND ONLINE BUYERS WILL RECEIVE PURCHASE CONFIRMATION RECEIPT
THROUGH EMAIL OR WHATSAPP IN WHICH THERE WILL BE NECESSSARY DETAILS TO
CLAIM THE NFTS</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                <br><br>      <p class="text-muted">TEAM MEMBERS APPOINTED BY YAS PRODUCTIONS WILL HAVE AUTHORITY TO SEND
DETAILS OF THE BUYERS LIKE NAME, PHONE NUMBER,EMAIL ID AND MATIC
BLOCKCHAIN ADDRESS (METAMASK), AFTER THEY HAVE RECIVED THE PAYMENT. THE
CONFIRMATION MAIL WILL BE SENT WITHIN 60 MINUTES AFTER WE RECEIVE THE
DETAILS FROM THE TEAM MEMBERS APPOINTED BY YAS PRODUCTION.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                   <br><br> <p class="text-muted">ON THE SCHEDUELED EVENT DAY, YAS PRODUCTIONS TEAM MEMBERS AT THE ENTRY
CAN VERIFY THE GUESTS USING THEIR OTP AND NFT NUMBER.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
 ...
 -->
    ...
    <section id="contact">
                ...
                <div data-tf-widget="BBuhuRnE" data-tf-hide-headers data-tf-iframe-props="title=Contact Form" 
                style="width:100%;height:900px;"></div><script src="//embed.typeform.com/next/embed.js"></script>
